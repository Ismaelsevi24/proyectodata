...
def recibeInsertRegisterUser(cedula, name, surname, estacocivil, id_area, id_rol, pass_user):
        ...
        try:
            with connectionBD() as conexion_MySQLdb:
                with conexion_MySQLdb.cursor(dictionary=True) as mycursor:
                    sql = """
                    INSERT INTO usuarios(cedula, nombre_usuario, apellido_usuario, id_estado_civil, id_area, id_rol, password) 
                    VALUES (%s, %s, %s, %s, %s, %s, %s)
                    """
                    valores = (cedula, name, surname, estacocivil, id_area, id_rol, nueva_password)
...
def info_perfil_session(id):
    ...
    try:
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                querySQL = "SELECT id_usuario, nombre_usuario, apellido_usuario, id_estado_civil, cedula, id_area, id_rol FROM usuarios WHERE id_usuario = %s"
...
def procesar_update_perfil(data_form,id):
    ...
    id_estado_civil = data_form['id_estado_civil']
            ...
            with connectionBD() as conexion_MySQLdb:
                with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                    querySQL = """
                        ...
                        WHERE id_usuario = %s
                    """
                    params = (nombre_usuario,apellido_usuario, id_estado_civil, id_area, id_rol,
    ...
    if not pass_actual and not new_pass_user and not repetir_pass_user:
            return updatePefilSinPass(id_user, nombre_usuario, apellido_usuario, id_estado_civil, id_area, id_rol)
                                ...
                                with connectionBD() as conexion_MySQLdb:
                                    with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                                        querySQL = """
                                            ...
                                            WHERE id_usuario = %s
                                        """
                                        params = (nombre_usuario,apellido_usuario, id_estado_civil, id_area,
                                                  nueva_password, id_user)
                                        cursor.execute(querySQL, params)
                                        conexion_MySQLdb.commit()
...
def updatePefilSinPass(id_user, nombre_usuario, apellido_usuario, id_estado_civil, id_area, id_rol):
    try:
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                querySQL = """
                    ...
                    WHERE id_usuario = %s
                """
                params = ( nombre_usuario, apellido_usuario, id_estado_civil, id_area, id_rol, id_user)
                cursor.execute(querySQL, params)
                conexion_MySQLdb.commit()
